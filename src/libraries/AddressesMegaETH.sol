...
library AddressesMegaETH {
    ...
    address internal constant ADDR_UNISWAP_QUOTER_V2 = address(0); // TBD
    address internal constant ADDR_WETH = address(0); // TBD - Wrapped ETH on MegaETH mainnet
}
